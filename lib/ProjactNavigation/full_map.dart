...
import 'package:mapboxtest/ProjactNavigation/utils/request_location_permission.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          MapboxMap(
            accessToken: "pk.eyJ1IjoiemlkZWxraGlyYWxpIiwiYSI6ImNrc21mbGxybzE2N28yenFvMmthZ3NmcXgifQ.UsCiUybSYJXzuOLNqv4E_w",//DotEnv.dotenv.env['MAPBOX_ACCESS_TOKEN'],
